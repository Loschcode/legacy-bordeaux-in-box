  ...
  this.Payment = (function() {
    ...
    Payment.prototype.initStripe = function() {
      return this.handler = StripeCheckout.configure({
        ...
        closed: function() {
          return $('#trigger-payment').html($('#trigger-payment').data('text'));
        }
      });
    };
    ...
    Payment.prototype.displayLoading = function() {
      return $('#trigger-payment').html('<i class="fa fa-spinner fa-spin"></i>');
    };
