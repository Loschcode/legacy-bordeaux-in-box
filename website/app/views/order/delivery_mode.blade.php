  ...
  <div class="spacer50"></div>
   ...
   <div class="container">
      ...
      <div class="clearfix"></div>
        ...
        <nav>
          <ul class="pager">
            <li><a href="{{url('/order/billing-address')}}">&larr; Retour aux informations de facturation</a></li>
          </ul>
        </nav>
     	</div>
...
<h2>En livraison ou à emporter ?</h2>

{{ Form::open() }}

	{{ Form::label('0', 'En livraison ('.DeliverySetting::first()->regional_delivery_fees.'€)') }}
	{{ Form::radio('take_away', 0, (!$order_preference->take_away) ? true : Input::old(0), array('id' => 0))}}<br />


	{{ Form::label('1', 'A emporter depuis un point de rendez-vous') }}
	{{ Form::radio('take_away', 1, ($order_preference->take_away) ? true : Input::old(1), array('id' => 1))}}<br />

  	
  	<a href="{{url('/order/billing-address')}}">Retour aux informations de facturation</a>
