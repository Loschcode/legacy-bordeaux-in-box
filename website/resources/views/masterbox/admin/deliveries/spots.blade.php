...
<table class="js-datatable-simple">
  ...
  <tbody>
    ...
    <tr>
      ...
      <th>
        <a class="button button__link" href="{{ url('/admin/deliveries/download-csv-orders-from-series-and-spot/' . $series->id . '/' . $spot->id) }}">Commandes</a>
      </th>
      <th>

        <a title="Envoyer les emails pour confirmer les livraisons au point relais ?" class="button button__table js-tooltip" href="action('MasterBox\Admin\EmailManagerController@getSendEmailToSeriesSpotOrders', ['series_id' => $seroes->id, 'spot_id' => $spot->id])"><i class="fa fa-envelope"></i></a>
