<div class="container">
	...
	<div class="row bs-wizard" style="border-bottom:0;">
		...
		<div class="col-xs-2 bs-wizard-step {{ $states['step1'] }} col-md-offset-1">
			...
			<a {{ $tooltips['step1'] }} href="{{ action('MasterBox\Customer\OrderController@getChooseBox') }}" class="bs-wizard-dot"></a>
		...
		<div class="col-xs-2 bs-wizard-step {{ $states['step2'] }}">
			...
			<div class="progress"><div class="progress-bar"></div></div>
			<a {{ $tooltips['step2'] }} href="{{ action('MasterBox\Customer\OrderController@getBoxForm') }}" class="bs-wizard-dot"></a>
		...
		<div class="col-xs-2 bs-wizard-step {{ $states['step3'] }}">
			...
			<div class="progress"><div class="progress-bar"></div></div>
			<a {{ $tooltips['step3'] }} href="{{ action('MasterBox\Customer\OrderController@getChooseFrequency') }}" class="bs-wizard-dot"></a>
		...
		<div class="col-xs-2 bs-wizard-step {{ $states['step4'] }}">
			...
			<div class="progress"><div class="progress-bar"></div></div>
			<a {{ $tooltips['step4'] }} href="{{ action('MasterBox\Customer\OrderController@getBillingAddress') }}" class="bs-wizard-dot"></a>
		...
		<div class="col-xs-2 bs-wizard-step {{ $states['step5'] }}">
			...
			<div class="progress"><div class="progress-bar"></div></div>
			<a {{ $tooltips['step5'] }} href="{{ action('MasterBox\Customer\OrderController@getPayment') }}" class="bs-wizard-dot"></a>
