            ...
            <div class="panel__content --white">
              ...
              <div class="row billing__container">
                <div class="grid-6">
                  ...
                  {!! Form::text("destination_first_name", Request::old("destination_first_name"), ['class' => 'billing__input']) !!}
                ...
                <div class="grid-6">
                  ...
                  {!! Form::text("destination_last_name", Request::old("destination_last_name"), ['class' => 'billing__input']) !!}
              ...
              <div class="row billing__container">
                <div class="grid-6">
                  ...
                  {!! Form::text("destination_city", Request::old("destination_city"), ['class' => 'billing__input']) !!}
                ...
                <div class="grid-6">
                  ...
                  {!! Form::text("destination_zip", Request::old("destination_zip"), ['class' => 'billing__input']) !!}
              ...
              {!! Form::textarea("destination_address", Request::old("destination_address"), ['class' => 'billing__input --textarea']) !!}
