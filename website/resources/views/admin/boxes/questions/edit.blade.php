...
@section('content')
  ...
  <div class="form-group @if ($errors->first('question')) has-error has-feedback @endif">
    ...
    {!! Form::text("question", (Input::old("question")) ? Input::old("question") : $question->question, ['class' => 'form-control']) !!}
  ...
  <div class="form-group @if ($errors->first('short_question')) has-error has-feedback @endif">
    ...
    {!! Form::text("short_question", (Input::old("short_question")) ? Input::old("short_question") : $question->short_question, ['class' => 'form-control']) !!}
  ...
  <div class="form-group @if ($errors->first('filter_must_match')) has-error has-feedback @endif">
    ...
    {!! Form::select('filter_must_match', ['0' => 'Non', '1' => 'Oui'], (Input::old("filter_must_match")) ? Input::old("filter_must_match") : $question->filter_must_match, ['class' => 'form-control']) !!}
  ...
  <div class="form-group @if ($errors->first('slug')) has-error has-feedback @endif">
    ...
    {!! Form::text("slug", (Input::old("slug")) ? Input::old("slug") : $question->slug, ['class' => 'form-control']) !!}
  ...
  <div class="form-group @if ($errors->first('position')) has-error has-feedback @endif">
    ...
    {!! Form::select('position', $position_listing, (Input::old("position")) ? Input::old("position") : $question->position, ['class' => 'form-control']) !!}
