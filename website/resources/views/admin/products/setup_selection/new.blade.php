...
@section('content')
  ...
  {!! Form::select('large_products', generate_unity_form(), (Input::old("large_products")) ? Input::old("large_products") : Config::get('bdxnbx.filters_setup.large_products')) !!}
  ...
  {!! Form::select('medium_products', generate_unity_form(), (Input::old("medium_products")) ? Input::old("medium_products") : Config::get('bdxnbx.filters_setup.medium_products')) !!}
  ...
  {!! Form::select('small_products', generate_unity_form(), (Input::old("small_products")) ? Input::old("small_products") : Config::get('bdxnbx.filters_setup.small_products')) !!}
  ...
  <div class="form-group @if ($errors->first('max_desired_cost')) has-error has-feedback @endif">
    ...
    {!! Form::text("max_desired_cost", Input::old("max_desired_cost"), ['placeholder' => 'e.g. 10.45']) !!} € <em>(Optionnel)</em>
  </div>
  ...
  <div class="form-group @if ($errors->first('max_desired_weight')) has-error has-feedback @endif">
    ...
    {!! Form::text("max_desired_weight", Input::old("max_desired_weight"), ['placeholder' => 'e.g. 850.10']) !!} grammes <em>(Optionnel)</em>
  </div>
  ...
  {!! Form::select('high_priority_difference', generate_percent_form(), (Input::old("high_priority_difference")) ? Input::old("high_priority_difference") : Config::get('bdxnbx.filters_setup.high_priority_difference')) !!}
  ...
  {!! Form::select('low_priority_difference', generate_percent_form(), (Input::old("low_priority_difference")) ? Input::old("low_priority_difference") : Config::get('bdxnbx.filters_setup.low_priority_difference')) !!}
